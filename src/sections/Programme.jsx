...
const Programme = ({onApplyNowClick,programmeRef}) => {
  return (
    <div className="mx-16 py-14" ref={programmeRef}>
      <div className="m-6 max-lg:text-center max-lg:flex-center max-lg:flex-col">
        <p className="text-[56px] max-lg:text-[42px] max-sm:text-[25px] leading-[35px] max-lg:leading-[28px] max-sm:leading-[20px] font-semibold border-b-[10px] max-sm:border-b-[6px] border-yellow w-max">
          Programme we offer
        </p>
      ...
      <div className="max-lg:flex-center max-lg:flex-col">
        ...
        <div className="flex gap-12 items-end my-10 max-lg:my-8 max-lg:flex-col max-lg:items-center max-lg:gap-6">
          <div className="w-[720px] h-[730px] max-lg:w-[600px] max-lg:h-[650px]  rounded-2xl p-6 bg-[#FFDD81] mt-16 ml-8 max-lg:mt-0 max-lg:ml-0 max-sm:h-[400px] max-sm:w-[280px] max-sm:p-3">
            <img
              src={posterACCA}
              alt="poster-1"
          ...
          <div className="hidden max-lg:block max-sm:w-full ">
            ...
            <div className="flex w-[600px] justify-between items-center max-sm:w-[350px] max-sm:mt-8">
              ...
              <div className="h-8 flex justify-between bg-orange w-30 p-1 rounded-full max-sm:w-22 max-sm:h-8">
        ...
        <div className="flex  flex-row-reverse  max-lg:flex-col max-lg:items-center gap-12 max-lg:gap-6 items-end my-10 max-lg:my-8">
          <div className="w-[720px] h-[730px]  rounded-2xl p-6 bg-red mt-16 ml-10 max-lg:mt-0 max-lg:ml-0 max-lg:w-[600px] max-lg:h-[650px] max-sm:h-[400px] max-sm:w-[280px] max-sm:p-3">
            <img
              src={posterBBA}
              alt="poster-1"
              className="w-full h-full rounded-3xl"
        ...
        <div className="flex gap-12 items-end my-10 max-lg:flex-col max-lg:my-8  max-lg:items-center max-lg:gap-6">
          <div className="w-[720px] h-[730px] rounded-2xl p-6 bg-blue mt-16 ml-10 max-lg:mt-0 max-lg:ml-0 max-lg:w-[600px] max-lg:h-[650px] max-sm:h-[400px] max-sm:w-[280px] max-sm:p-3">
            <img
              src={posterAIML}
              alt="poster-1"
              className="w-full h-full rounded-3xl"
        ...
        <div className="flex flex-row-reverse items-end my-10 max-lg:my-8 max-lg:flex-col max-lg:items-center max-lg:gap-6">
          <div className="w-[1720px] h-[730px] rounded-2xl p-6 bg-blue mt-16 ml-10 max-lg:mt-0 max-lg:ml-0 max-lg:w-[600px] max-lg:h-[650px] max-sm:h-[400px] max-sm:w-[280px] max-sm:p-3">
            <img
              src={posterMCA}
              alt="poster-1"
              className="w-full h-full rounded-3xl"
        ...
        {/* Poster 5 */}
        <div className="flex gap-12 items-end my-10 max-lg:my-8 max-lg:flex-col max-lg:items-center max-lg:gap-6">
          <div className="w-[720px] h-[730px] rounded-2xl p-6 bg-yellow mt-16 ml-10 max-lg:mt-0 max-lg:ml-0 max-lg:w-[600px] max-lg:h-[650px] max-sm:h-[400px] max-sm:w-[280px] max-sm:p-3">
            <img
              src={posterBA}
              alt="poster-1"
              className="w-full h-full rounded-3xl"
